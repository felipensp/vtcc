...
fn build_steps(vtccdir string) ! {
	...
	deps['building bt-log.o (tcc_backtrace symbol)'] = 'v -d no_main -skip-unused -no-builtin -o bt-log.o lib/bt-log.v'
	deps['building bcheck.o: '] = 'v -d no_main -skip-unused -no-builtin -o bcheck.o lib/bcheck.v'
	deps['building bt-exe.o: '] = 'v -d no_main -skip-unused -no-builtin -o bt-exe.o lib/bt-exe.v'
	deps['building dso.o: '] = 'v -d no_main -no-builtin -o dso.o lib/dsohandle.v'
	...
	deps['building libtcc1.a: '] = 'rm -f libtcc1.a && ar rcs libtcc1.a libtcc1.o vtcc.o bt-exe.o bt-log.o bcheck.o dso.o'
	deps['buildind vtcc: '] = 'v -skip-unused -d vtcc_dir=${vtccdir} -o vtcc src/'
